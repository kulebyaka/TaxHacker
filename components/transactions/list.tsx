...
export function TransactionList({ transactions, fields = [], isISDOCEnabled = false }: { transactions: Transaction[]; fields?: Field[]; isISDOCEnabled?: boolean }) {
